...
const BOOST_REFLECT_COOLDOWN: float = FlightTuning.BOOST_REFLECT_COOLDOWN
const BOOST_REFLECT_COOLDOWN_STEP: float = FlightTuning.BOOST_REFLECT_COOLDOWN_STEP
const BOOST_REFLECT_COOLDOWN_MIN: float = FlightTuning.BOOST_REFLECT_COOLDOWN_MIN
const BOOST_CHAIN_REFLECT_THRESHOLD: int = FlightTuning.BOOST_CHAIN_REFLECT_THRESHOLD
const BOOST_CHAIN_WINDOW: float = FlightTuning.BOOST_CHAIN_WINDOW
