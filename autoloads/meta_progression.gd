...
const SHOP_ITEMS: Array[Dictionary] = [
	...
	{
		"id": "meta_reserves",
		"name": "Extra Continues",
		"icon": "🔄",
		"description": "Start every run with +1 continue per level.",
		"costs": [200, 400],
		"category": "system",
	...
	},
	{
		...
		"icon": "🛰️",
		"description": "Unlock Orbital Array as a\npossible boss reward.",
		"costs": [250],
		"category": "blueprint",
	...
	},
	{
		...
		"icon": "🗡️",
		"description": "Unlock Piercing Rounds as a\npossible boss reward.",
		"costs": [250],
		"category": "blueprint",
	...
	},
	{
		...
		"icon": "💣",
		"description": "Unlock Explosive Rounds as a\npossible boss reward.",
		"costs": [250],
		"category": "blueprint",
...
const SHIP_VARIANTS: Array[Dictionary] = [
	{
		...
		"name": "Swallowtail",
		"icon": "🦋",
		"description": "Balanced speed, fire rate,\nand starting lives.",
		"cost": 0,
...
const CONSUMABLE_ITEMS: Array[Dictionary] = [
	{
		...
		"name": "Extra Continue",
		"icon": "⭐",
		"description": "+1 continue for your next run.\nBuy up to 3 extra continues.",
		"cost": 120,
		"category": "consumable",
	...
	},
	{
		...
		"name": "Starting Power-Up",
		"icon": "🎁",
		"description": "Start your next run with\none random power-up.",
		"cost": 100,
		"category": "consumable",
		"color": Color(0.4, 0.85, 1.0),
	},
...
const CHALLENGE_MODIFIERS: Array[Dictionary] = [
	{
		...
		"name": "Rapid Assault",
		"icon": "⏩",
		"description": "Enemies arrive 20% faster.",
		"bonus_pct": 0.20,
		"cost": 300,
		"color": Color(1.0, 0.35, 0.35),
	},
	{
		...
		"name": "Armored Fleet",
		"icon": "🔩",
		"description": "Regular enemies have 30% more health.",
		"bonus_pct": 0.30,
		"cost": 300,
	...
	},
	{
		...
		"name": "Energy Drought",
		"icon": "🌑",
		"description": "Collect 50% more orb points per wave.",
		"bonus_pct": 0.25,
		"cost": 300,
