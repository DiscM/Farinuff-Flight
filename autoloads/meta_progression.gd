...
const SHOP_ITEMS: Array[Dictionary] = [
	...
	},
	{
		...
		"icon": "🔄",
		"description": "+1 starting continue per level.",
		"costs": [200, 400],
		"category": "system",
	...
	},
	{
		...
		"icon": "🛰️",
		"description": "Adds Orbital Array to boss rewards.",
		"costs": [250],
		"category": "blueprint",
	...
	},
	{
		...
		"icon": "🗡️",
		"description": "Adds Piercing Rounds to boss rewards.",
		"costs": [250],
		"category": "blueprint",
...
const CONSUMABLE_ITEMS: Array[Dictionary] = [
	{
		...
		"name": "Extra Continue",
		"icon": "⭐",
		"description": "+1 continue next run. Max 3.",
		"cost": 120,
		"category": "consumable",
	...
	},
	{
		...
		"icon": "🎁",
		"description": "+1 random power-up next run.",
		"cost": 100,
		"category": "consumable",
		"color": Color(0.4, 0.85, 1.0),
	},
