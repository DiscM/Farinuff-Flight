...
**Status**: implementation in progress; native Player damage and invulnerability are at their manual-playtest gate
...
- [ ] Port projectile-dependent boost deflection and chain behavior; keep it separate from ordinary damage routing.
...
- [x] Connect pooled player and enemy projectiles to native 3D hit detection and route Enemy Projectile hits once through the native gameplay controller; boost deflection remains separate pending work above.
