...
`../mockups/shader_previews/in_game_3d_integration.png` is captured from the real game
scene using `tests/ship_render_layer_3d_smoke.tscn`.
`../mockups/shader_previews/in_game_boss_3d_integration.png` exercises every boss identity
and the Tempest shield array through `tests/boss_render_layer_3d_smoke.tscn`.
`../mockups/shader_previews/in_game_player_upgrades_3d.png` shows the fully upgraded player
